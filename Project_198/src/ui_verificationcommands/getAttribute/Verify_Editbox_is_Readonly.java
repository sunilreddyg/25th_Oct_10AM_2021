...
public class Verify_Editbox_is_Readonly
{
	...
	public static void main(String[] args) 
	{
		...
		//getattribute retur null value when required property doesn't exist at html
		...
		//Condition to verify editbox readonly status..
		if(Value.equals("true"))
			System.out.println("Editbox available in readonly mode");
		else
			System.out.println("Editbox not available at readon only mode");
