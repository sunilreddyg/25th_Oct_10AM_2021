...
public class Verify_MultipleSelection_Count {
	...
	public static void main(String[] args) throws Exception {
		...
		if(flag==true)
		{
			 ...
			 //Get Dropdown Count only Selected one
			 int Count=CountrySelector.getAllSelectedOptions().size();
			 
			 
			 if(Count==3)
				 System.out.println("Testpass, Expected options are selected");
			 else
				 System.out.println("Testfail Expected options are not selected");
