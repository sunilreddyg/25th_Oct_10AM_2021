...
public class CommonReusableActions
{
	...
	String MainwindowId;
	/*
	 * keyword:--> Launch browsers [chrome,firefox,ie]
	 * Author:-->
	 * CreatedOn:-->
	 * ParametersUsed:--->
	 */
	 ...
	 * Parameters Used:-->  Local Parameter
	 */
	public boolean verify_Element_Presented_Source(WebElement Element)
	{
		boolean flag=false;
		try {
	 ...
	 * Parameters Used:-->  Local Parameter
	 */
	public boolean verify_text_presented_At_location(WebElement Element,String text)
	{
		boolean flag=false;
		try {
	 ...
	 * Parameters Used:-->  Local Parameter
	 */
	public boolean Verify_element_text(WebElement Element,String exp_text)
	{
